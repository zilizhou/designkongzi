...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        serif: ["var(--font-serif)", '"Songti SC"', '"STSong"', '"Noto Serif SC"', "serif"],
        "serif-en": ["var(--font-serif-en)", '"Source Serif 4"', "Georgia", "serif"],
        sans: ['"PingFang SC"', '"Hiragino Sans GB"', '"Noto Sans SC"', "system-ui", "sans-serif"],
      },
      boxShadow: {
